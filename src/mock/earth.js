const data = [
    ...
    // { name: '马其顿', value: [21.26, 42.01, 7] }, 
    // { name: '多哥', value: [1.2, 6.09, 9] },
    // { name: '汤加', value: [-174, -21.1, 3] },
    // { name: '突尼斯', value: [10.11, 36.5, 8] },
    // { name: '土耳其', value: [32.54, 39.57, 10] },
    // { name: '土库曼斯坦', value: [57.5, 38, 5] },
    // { name: '图瓦卢', value: [179.13, -8.31, 9] },
    // { name: '乌干达', value: [32.3, 0.2, 9] },
    // { name: '乌克兰', value: [30.28, 50.3, 5] },
    // { name: '阿联酋', value: [54.22, 24.28, 10] },
    // { name: '英国', value: [-0.05, 51.36, 13] },
    // { name: '坦桑尼亚', value: [35.45, -6.08, 9] },
    // { name: '坦桑尼亚', value: [35.43455, -6.09, 9] },
    // { name: '坦桑尼亚', value: [35.4005, -6.04, 2] },
    // { name: '坦桑尼亚', value: [35.457347, -6.03, 1] },
    // { name: '坦桑尼亚', value: [35.4445, -6.05, 9] },
    // { name: '坦桑尼亚', value: [35.3335, -6.022, 9] },
    // { name: '坦桑尼亚', value: [35.4995, -6.755, 9] },
    // { name: '坦桑尼亚', value: [35.445, -6.088, 9] },
    // { name: '美国', value: [-77.02, 39.91, 14] },
    // { name: '美属维尔京群岛', value: [-64.56, 18.21, 19] },
    // { name: '乌拉圭', value: [-56.11, -34.5, 18] },
    // { name: '乌兹别克斯坦', value: [69.1, 41.2, 1] },
    // { name: '乌兹别克斯坦', value: [69.4, 40.2, 3] },
    // { name: '乌兹别克斯坦', value: [69.3, 40.1, 3] },
    // { name: '乌兹别克斯坦', value: [69.5, 44.6, 3] },
    // { name: '乌兹别克斯坦', value: [69.6, 39.2, 3] },
    // { name: '瓦努阿图', value: [168.18, -17.45, 3] },
    // { name: '委内瑞拉', value: [-66.55, 10.3, 3] },
    // { name: '越南', value: [105.55, 21.05, 2] },
    // { name: '南斯拉夫', value: [20.37, 44.5, 11] },
    // { name: '赞比亚', value: [28.16, -15.28, 8] },
    // { name: '津巴布韦', value: [31.02, -17.43, 12] },
]
...
for (let i = 0; i < 20; ++i) {
    ...
    obj.itemStyle = {
        color: z > 1 ? 'rgba(21, 254, 255,0.5)' : 'rgba(32, 124, 184,0.5)',
    }
    obj.value = [x, y, z]
    data.push(obj)
}
...
for (let i = 0; i < 15; ++i) {
    const obj = {}
    const x = Math.random() * 20 + 150
    const y = Math.random() * 20 + 30
    const z = Math.random() * 1.2
    obj.itemStyle = {
        color: z > 1 ? 'rgba(21, 254, 255,0.5)' : 'rgba(32, 124, 184,0.5)',
    }
    obj.value = [x, y, z]
